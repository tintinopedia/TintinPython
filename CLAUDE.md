...
- A small number of scripts use a non-date prefix for themed projects (e.g. `F1_Bank.py`, `F1_Game.py`). These are standalone exercises just like the date-named ones — the prefix is a project/theme name, not a special category.
